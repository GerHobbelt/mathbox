...
[],b)if("style"==d)for(j in b.style)c.push(j);else c.push(d);return c}var c=[],d,e={};a.forEach(function(a){var c=a[0],d=a[1]||"",g=a[2]||{},k=a[3]||{};if("set"==c)return null;"add"==c&&(d=g.sequence);"remove"==c&&(k=g);b(a).forEach(function(a){a=[d,a].join(".");e[a]||(e[a]=[]);k=k||{};e[a].push((k.delay||0)+(k.duration||0)+(k.hold||0))})});var g=0;for(d in e)var k=e[d]=e[d].reduce(function(a,b){return a+b}),g=Math.max(g,k);a.forEach(function(a){var d=a[0],k=a[1]||"",m=a[2]||{},n=a[3]||{},u;if("set"==
d)return c.push(a);"add"==d&&(u=k,k=m.sequence);"remove"==d&&(n=m);b(a).forEach(function(a){var b=[k,a].join("."),h=n.delay||0,v=n.duration||0,w=n.hold||0;void 0!==e[b]&&(h+=g-e[b],delete e[b]);n={delay:h,duration:v,hold:w};"add"==d&&c.push([d,u,m,n]);"remove"==d?c.push([d,k,n]):(b={},b[a]=m.style&&void 0!==m.style[a]?m.style[a]:m[a],c.push([d,k,b,n]))})});return c},apply:function(a,b,c,d){var e=this._stage;_.each(a,function(a){var k=a[0]||"",h=a[1]||"",f=a[2]||{},l=a[3]||{};"remove"==k&&(l=f);b&&
...
d,k);this.ticks=new MathBox.Renderable.Ticks(m,n,u,c,k);this.labels=new MathBox.Renderable.Labels(f,l,t,e,k)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
g=e.data,k=e.arrow,h=e.n,f=e.size,l=this.style.get("mathScale");console.log("3. size="+f);console.log("scale="+l);var m=0,n=0;MathBox.loop(2*h,function(h){p=g&&void 0!==g[h]?g[h]:e.expression.call(this,n,m);var t=0,r=0,q=0;if(p instanceof Array){var v=p.length;0<v&&(t=p[0]);1<v&&(r=p[1]);2<v&&(q=p[2])}else t=h,r=+p,q=0;d[h].set(t,r,q);b[h].set(t,r,q);a&&k&&1==h%2&&(t=MathBox.Vector.vLast,r=MathBox.Vector.vCurrent,r.copy(b[h]),t.copy(b[h-1]),a.to(r),a.to(t),r.sub(t).multiplyScalar(l),v=r.length(),
console.log("l="+v),console.log("size="+f),q=Math.min(1,.5*v/f),console.log("clipped="+q),q=(1-(1-q)*(1-q))*f,console.log("clipped="+q),v-=q,r.normalize().multiplyScalar(v).divideScalar(l).add(t),a.from(r),b[h].copy(r),c[n].set({size:q}));n=m?n+1:n;m=(m+1)%2}.bind(this))}});MathBox.Primitive.types.vector=MathBox.Vector;MathBox.Surface=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
{type:"points",dynamic:a.live},b);if(a.shaded){var e=this.tangents=[[],[]];MathBox.loop(c[0]*c[1],function(){e[0].push(new THREE.Vector3);e[1].push(new THREE.Vector3)})}this.calculate()},calculate:function(){var a=this.vertices,b=this.tangents,c=this.get(),d=c.data,e=c.domain,g=c.n,k=c.flipSided,h=k?1:0,k=k?0:1;"number"==typeof g&&(g=[g,g]);var f=e[0][0],l=e[1][0],m=(e[0][1]-f)/(g[0]-1),n=(e[1][1]-l)/(g[1]-1),u,t=0;MathBox.loop(g[1],function(b){f=e[0][0];MathBox.loop(g[0],function(e){u=d&&void 0!==
...
u=(c[0][1]-m)/(k[0]-1),t=(c[1][1]-n)/(k[1]-1),r=0;MathBox.loop(k[1],function(b){m=c[0][0];MathBox.loop(k[0],function(b){a[r].set(m,n,0);m+=u;r++}.bind(this));n+=t}.bind(this));l={uniforms:l,shaders:{position:function(a,b){g?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};this.mesh.set(l);
