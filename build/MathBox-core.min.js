...
this.diff),b=b.size,h=new THREE.Matrix4;h.set(g.x,d.x,k.x,e.x,g.y,d.y,k.y,e.y,g.z,d.z,k.z,e.z,0,0,0,1);h.scale(new THREE.Vector3(b,b,b));this.object.updateMatrix();this.object.matrix.multiply(h);h.identity().setPosition({x:0,y:.5-c,z:0});this.object.matrix.multiply(h);if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");this.object.matrixAutoUpdate=!1;this.object.matrixWorldNeedsUpdate=!0;MathBox.Renderable.prototype.adjust.call(this,a)}}});
