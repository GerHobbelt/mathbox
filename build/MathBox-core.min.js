...
this.diff),b=b.size,h=new THREE.Matrix4;if(0===h.determinant())throw Error("Matrix is singular!!!");h.set(g.x,d.x,k.x,e.x,g.y,d.y,k.y,e.y,g.z,d.z,k.z,e.z,0,0,0,1);if(0===h.determinant())throw Error("Matrix is singular!!!");h.scale(new THREE.Vector3(b,b,b));if(0===h.determinant())throw Error("Matrix is singular!!!");this.object.updateMatrix();if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");this.object.matrix.multiply(h);if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");
