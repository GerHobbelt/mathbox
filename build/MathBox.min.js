...
this.diff),b=b.size,k=new THREE.Matrix4;k.set(f.x,d.x,h.x,e.x,f.y,d.y,h.y,e.y,f.z,d.z,h.z,e.z,0,0,0,1);k.scale(new THREE.Vector3(b,b,b));this.object.updateMatrix();this.object.matrix.multiply(k);k.identity().setPosition({x:0,y:.5-c,z:0});this.object.matrix.multiply(k);if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");this.object.matrixAutoUpdate=!1;this.object.matrixWorldNeedsUpdate=!0;MathBox.Renderable.prototype.adjust.call(this,a)}}});
