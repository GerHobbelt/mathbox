...
this.diff),b=b.size,k=new THREE.Matrix4;if(0===k.determinant())throw Error("Matrix is singular!!!");k.set(f.x,d.x,h.x,e.x,f.y,d.y,h.y,e.y,f.z,d.z,h.z,e.z,0,0,0,1);if(0===k.determinant())throw Error("Matrix is singular!!!");if(isNaN(b))throw Error("size is NaN: "+b);k.scale(new THREE.Vector3(b,b,b));if(0===k.determinant())throw Error("Matrix is singular!!!");this.object.updateMatrix();if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");this.object.matrix.multiply(k);if(0===
