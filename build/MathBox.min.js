...
this.diff),b=b.size,k=new THREE.Matrix4;if(0===k.determinant())throw Error("Matrix is singular!!!");k.set(f.x,d.x,h.x,e.x,f.y,d.y,h.y,e.y,f.z,d.z,h.z,e.z,0,0,0,1);if(0===k.determinant())throw Error("Matrix is singular!!!");k.scale(new THREE.Vector3(b,b,b));if(0===k.determinant())throw Error("Matrix is singular!!!");this.object.updateMatrix();if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");this.object.matrix.multiply(k);if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");
k.identity().setPosition({x:0,y:.5-c,z:0});if(0===k.determinant())throw Error("Matrix is singular!!!");this.object.matrix.multiply(k);if(0===this.object.matrix.determinant())throw Error("Matrix is singular!!!");this.object.matrixAutoUpdate=!1;this.object.matrixWorldNeedsUpdate=!0;MathBox.Renderable.prototype.adjust.call(this,a)}}});MathBox.Renderable.Ticks=function(a,b,c,d,e){this.points=a;this.signs=b;this.epsilon=c;MathBox.Renderable.call(this,d,e)};
