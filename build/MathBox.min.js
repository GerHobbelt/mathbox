...
q=c.tickScale,c=c.decimals,v=this.points,u=this.labelPoints,t=this.labelTangent,r=this.tickPoints,w=this.tickSigns,x=[0,0,0],z=new THREE.Vector3;new THREE.Vector4;var y=a.axis(d),A=y[0],y=y[1],C=(y-A)/(g-1);z.set.apply(z,e);MathBox.loop(g,function(a){x[d]=A+a*C;v[a].set.apply(v[a],x);v[a].addSelf(z)});this.line.show(h);this.arrow.show(f);g=this.scale=MathBox.Ticks(A,y,l,m,q,!0);this.ticks.show(!!l);if(l){l=Math.floor(r.length/2);g.length>l&&(g=g.slice(0,l));var l=[0,0,0],B;l[2==d?0:1-d]=.01*(y-A);
this.epsilon.set.apply(this.epsilon,l);x=[0,0,0];_.each(g,function(a,b){x[d]=a;var c=2*b;r[c].set.apply(r[c],x);r[c].addSelf(z);w[c]=1;r[c+1].copy(r[c]);w[c+1]=-1;u[b].copy(r[c]);B=c+1});l=B+1;for(g=r.length;l<g;)r[l].copy(r[B]),w[l]=w[B],l++}x=[0,0,0];x[d]=1;t.set.apply(t,x);this.labels.show(!!k);this.labels.set("decimals",c)},make:function(){var a=this.get(),b=a.n,c=a.size,d=a.ticks,e=a.distance,f=a.formatter,h=this.style,k=this.points=[],g=this.labelPoints=[],l=this.labelTangent=new THREE.Vector3,
m=this.tickPoints=[],q=this.tickSigns=[],v=this.epsilon=new THREE.Vector3;MathBox.loop(b,function(a){k.push(new THREE.Vector3)});MathBox.loop(4*d,function(a){g.push(new THREE.Vector3)});MathBox.loop(8*d,function(a){m.push(new THREE.Vector3);q.push(1)});var d={dynamic:!0,size:c,offset:.5},c={dynamic:!0,size:.2*c},e={dynamic:!0,distance:e},u=function(b){b=this.scale[b];return 0!=b||a.zero?f?f(b):b:""}.bind(this);this.line=new MathBox.Renderable.Mesh(k,{dynamic:!0,type:"line"},h);this.arrow=new MathBox.Renderable.ArrowHead(k[b-
2],k[b-1],d,h);this.ticks=new MathBox.Renderable.Ticks(m,q,v,c,h);this.labels=new MathBox.Renderable.Labels(g,l,u,e,h)}});MathBox.Axis.validateArgs=function(a){"number"==typeof a&&(a={axis:a});return a};MathBox.Primitive.types.axis=MathBox.Axis;MathBox.Grid=function(a){null!==a&&MathBox.Primitive.call(this,a)};
...
g[8][1],g[9][1],g[10][1],g[11][1],g[12][1],g[13][1],g[14][1],g[15][1]);this.matrixZ.set(g[0][2],g[1][2],g[2][2],g[3][2],g[4][2],g[5][2],g[6][2],g[7][2],g[8][2],g[9][2],g[10][2],g[11][2],g[12][2],g[13][2],g[14][2],g[15][2]);var l=this.coefficients;this.matrixX.multiplySelf(l).transpose().multiplySelf(l);this.matrixY.multiplySelf(l).transpose().multiplySelf(l);this.matrixZ.multiplySelf(l).transpose().multiplySelf(l);var l={bezierSurfaceX:this.matrixX,bezierSurfaceY:this.matrixY,bezierSurfaceZ:this.matrixZ},
m=c[0][0],q=c[1][0],v=(c[0][1]-m)/(h[0]-1),u=(c[1][1]-q)/(h[1]-1),t=0;MathBox.loop(h[1],function(b){m=c[0][0];MathBox.loop(h[0],function(b){a[t].set(m,q,0);m+=v;t++}.bind(this));q+=u}.bind(this));l={uniforms:l,shaders:{position:function(a,b){f?(a.snippet("bezierSurface"+e),a.group(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.next(),a.snippet("mathTransform"),b.viewport(a),a.combine()):(a.snippet("bezierSurface"+e).snippet("mathTransform"),b.viewport(a))}}};
